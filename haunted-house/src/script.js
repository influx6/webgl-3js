...
bush5.position.set(- 1.2, 0.05, 2.6)
...
// Directional light
const moonLight = new THREE.DirectionalLight('#b9d5ff', 0.123)
...
// the camera needs to same clear color as the fog else we will
// see the background objects easily;
